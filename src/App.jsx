...
const ADMIN_RESET_QUERY_KEY = 'adminResetToken';
const ADMIN_RESET_REQ_KEY = 'adminResetReq';
const ADMIN_RESET_EMAIL = 'fatimfarooq@yahoo.com';
const ADMIN_RESET_API_BASE = 'http://localhost:8787';
const ADMIN_RESET_API_ENDPOINTS = [
  'http://localhost:8787',
  'http://127.0.0.1:8787'
];
const ADMIN_RESET_API_BASE_KEY = '_adminResetApiBase';
const CENTRAL_AUTH_CONFIG_PATH = './auth-api-config.json';
const ADMIN_RESET_CODE_KEY = '_adminResetCodeHash';
const FAILURE_LOG_KEY = '_failureLog';
const SCAN_DOC_TYPES = ['legal','tax','credit','transaction_invoice','bank','payroll','other'];
const ATT_QR_QUERY_KEY = 'attToken';
    ...
    <div>
      ...
      <div className="card mb-3">
        ...
        <div style={{fontSize:13,lineHeight:1.8,color:'#555'}}>
          1) Log in with your assigned username and password.<br />
          2) Use the tabs at the top for your tasks.<br />
          3) Save your work before closing the browser.<br />
      ...
      <div className="card mb-3">
        ...
        <div style={{fontSize:13,lineHeight:1.8,color:'#555'}}>
          1) Scan the live work QR code.<br />
          2) Log in (you can use Remember Device for faster repeat use).<br />
          3) Tap Check In or Check Out once.<br />
      ...
      {isAdmin && (
        <div className="card mb-3">
          ...
          <div style={{fontSize:13,lineHeight:1.8,color:'#555'}}>
            - Admin has full panel access from any device.<br />
            - Some features are local-device dependent (scanner automation, local kiosk station mode).<br />
            - Use Settings and Activity Log to diagnose issues quickly.
          </div>
        </div>
      )}
      <div className="card">
        ...
        <div style={{fontSize:13,lineHeight:1.8,color:'#555'}}>
          - Refresh once and retry.<br />
          - Confirm backend health if a tool depends on local service.<br />
  ...
  return (
    <div id="app-shell">
      ...
      <div className="content-area">
        ...
        {tab==='help'      && <HelpCenter currentUser={currentUser} />}
      </div>
